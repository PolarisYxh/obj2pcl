...
void VirtualPlaneIntersector::getFarNear(double x, double y, const osg::Matrix &invVPW, osg::Vec3f &nearpos, osg::Vec3f &farpos)
{
	/*osg::Vec4d near1 = osg::Vec4f(x, y, 0.f, 1.0) * invVPW;
    osg::Vec4d far1=osg::Vec4f(x, y, 1.f,1.0) * invVPW;
	nearpos=osg::Vec3f(near1.x(),near1.y(),near1.z());
	farpos= osg::Vec3f(far1.x(),far1.y(),far1.z());*/
	nearpos = osg::Vec3f(x, y, 0.f) * invVPW;
	farpos= osg::Vec3f(x, y, 1.f) * invVPW;
}
