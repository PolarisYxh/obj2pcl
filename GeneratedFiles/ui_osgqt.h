...
public:
    ...
    void setupUi(QWidget *osgqt)
    {
        ...
        camera_confirm->setGeometry(QRect(40, 180, 75, 23));
    ...
    void retranslateUi(QWidget *osgqt)
    {
        ...
        motion_delete->setText(QApplication::translate("osgqt", "cancel", nullptr));
